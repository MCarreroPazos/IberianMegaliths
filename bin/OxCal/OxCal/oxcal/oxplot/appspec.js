...
sss.options=["MenuItem","Spacer","Label","Button","ButtonLeft","ButtonCenter","ButtonRight","Key","Slider"];
...
ss=s.appendChild("title","Title","Text");
ss=s.appendChild("left","Left","Text");
ss=s.appendChild("top","Top","Text");
ss=s.appendChild("width","Width","Text");
ss=s.appendChild("height","Height","Text");
ss=s.appendChild("dialog","Dialog","Boolean");
ss=s.appendChild("body_type","Body type","Text");
ss.popup=true;
ss.options=["Existing div","New div","Existing iframe","New iframe"];
ss=s.appendChild("body_id","Body ID","Text");
...
ss=s.appendChild("iframe_src","Iframe src","Text");
ss.popup=true;
ss=s.appendChild("header_menu","Header menu ID","Text");
ss.popup=true;
ss=s.appendChild("footer_menu","Footer menu ID","Text");
ss.popup=true;
...
ss=s.appendChild("color_dialog","Color dialog","Boolean");
