...
function commandSpecification(d,id,name,old)
{
 d.write("<li> ");
...
if(!helpSource){helpSource=window.parent;};
function helpInsert(id)
{
 ...
 if(helpSource)
 {
  if(helpSource.oxcal)
  {
   helpSource.app.showTool("OxCalInput");
   if(helpSource.oxcal.editWindow)
   {
    helpSource.oxcal.editWindow.insert(txt);
   };
   return;
  };
...
function startCode(name)
{
  ...
  document.write('<div class="objIcon" onclick="helpInsert(\''+encodeURIComponent(name)+'\')"'
    +' style="position: relative; top: 0px; left: 2px;"><div class="circleGreen">'
...
function reveal(cls,nd)
{
 ...
 document.write('<link rel="stylesheet" type="text/css" href="../style/app.css"\/>');
 document.write('<link rel="stylesheet" type="text/css" href="../style/db.css"\/>');
 document.write('<link rel="stylesheet" type="text/css" href="../style/ochelp.css"\/>');
